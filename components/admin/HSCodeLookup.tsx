            ...
            >
                                ...
                                >
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex-1">
                                            <div className="flex items-center gap-3 mb-2">
                                                <code className="text-xl font-black text-slate-900 bg-slate-100 px-4 py-2 rounded-xl group-hover:bg-blue-50 group-hover:text-blue-700 transition-colors">
                                                    {suggestion.code}
                                                </code>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm font-bold text-blue-700">{suggestion.gstRate}</p>
                                        </div>
                                        <div className="space-y-1">
                                    ...
                                    <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-black text-blue-700">{suggestion.confidence}%</span>
                                        </div>
                                        <Button
                                            type="button"
                                            size="sm"
                ...
                <div className="p-6 border-t border-slate-100 bg-slate-50">
                    <p className="text-xs text-slate-500 font-medium text-center">
                        ...
                        <a href="https://cleartax.in/s/gst-hsn-lookup" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold hover:underline">
